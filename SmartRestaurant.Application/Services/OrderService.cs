    ...
    public class OrderService : IOrderService
    {
        ...
        public async Task<OrderDetailResponseDto> GetOrderByIdAsync(int id)
        {
            ...
            return new OrderDetailResponseDto
            {
                ...
                Items = billItems,
                SubTotal = billItems.Where(i => i.Status != "cancelled").Sum(i => i.LineTotal),
                TotalAmount = billItems.Where(i => i.Status != "cancelled").Sum(i => i.LineTotal),
                TotalItems = billItems.Where(i => i.Status != "cancelled").Sum(i => i.Quantity),
